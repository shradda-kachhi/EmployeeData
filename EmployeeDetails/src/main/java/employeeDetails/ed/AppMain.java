...
public class AppMain {
 ...
 // LaptopService laptopService = applicationContext.getBean("LaptopService",  LaptopService.class);
  ...
  //[employeeDetails.ed.Service.EmployeeServiceImp], but was actually of type  [com.sun.proxy.$Proxy28]
  ...
  //employeeService.getEmployeeList().forEach((i ->  System.out.println(i.toString())));
 // Employee employUp =  employeeService.getEmployee(2); System.out.println(employUp.toString());
